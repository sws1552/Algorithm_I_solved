...
//     let totalMin = arr1.reduce((acc, item, i) => {

//         if(parseInt(arr2[i].split(':')[0]) >= 29) arr2[i] = '21:00';
        
//         a += (parseInt(arr2[i].split(':')[0])*60) + parseInt(arr2[i].split(':')[1]);
//         b += (parseInt(arr1[i].split(':')[0])*60) + parseInt(arr1[i].split(':')[1]);

//         return a - b;
//     }, 0)

//     return mktime(totalMin);
// }
